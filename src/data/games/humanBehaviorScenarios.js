...
export const humanBehaviorScenarios = [
  ...
  },
  {
    ...
    explanations: [
      { text: "They're grading a big stack of similar assignments and keep it brief for everyone.", reasonable: true, note: 'Volume alone explains a lot of terse feedback.' },
      { text: "Brevity might just be their style.", reasonable: true, note: "Some people are blunt with everyone — it's not personal." },
      { text: "A grading deadline probably shaped it.", reasonable: true, note: 'Context you can\'t see (a grading deadline) often explains tone.' },
      ...
      { text: "They probably don't respect you as a student at all anymore, and this feedback proves it.", reasonable: false, note: "This reads a lot of personal meaning into what's likely just an efficient grading habit." },
    ],
    tier: 'easy',
  },
  {
